...
public class Dashboard extends JFrame {
    ...
    private JPanel gradePanel; // Removed redundant initialization
    ...
    private void initComponents() {
        ...
        mainContent.add(gradePanel, "Grades"); // Moved here
    ...
    private JPanel createDashboardPanel() {
        ...
        JLabel studentsCountLabel = new JLabel("248");
        ...
        JLabel coursesCountLabel = new JLabel("42");
        ...
        JLabel enrollmentsCountLabel = new JLabel("189");
